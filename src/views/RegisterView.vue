...
<template>
  <section class="grid place-items-center">
    ...
    >
      <h2 class="mt-2 px-4 text-center text-3xl font-bold tracking-widest sm:mb-8">Register</h2>
      <div class="flex flex-col gap-6">
        ...
        <button class="mt-6 w-64 self-center rounded-md bg-brand-200 hover:bg-brand transition ease-out duration-200 p-4 text-white">
          Register
        </button>
        <RouterLink to="login" class="self-center text-base text-brand-200 hover:text-brand hover:underline hover:decoration-2 hover:underline-offset-[5px]">
